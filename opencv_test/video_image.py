...
# 获取第N帧图片并保存
def get_one_fps_save(path, file_name, fps=1):
    # 打开图像
...
s = 'C90843783_1570650823000_23_68907616224.MP4'
get_one_fps_save(s, s.split('.')[0] + ".jpg")
# video2frames('C90843783_1570650823000_23_68907616224.MP4', only_output_video_info = True)
##### 测试
# pathIn = 'test.mp4'
